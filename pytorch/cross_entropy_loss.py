# I use this script to try to incorporate MLflow in the training chain
...
if __name__ == "__main__":
    ...
    mlflow.set_tracking_uri("file:///home/jianglin/workspace/sk/education/modified_centernet/CenterNet/my_resource/temp")
